...
table_pow_rec <- data.frame(c(
  ...
  ""
    ...
    "a hypothesis test expected effect sizes could yield significant results. If,",
    "not, indicate the interpretation of the data will not be based on p values.", 
...
r_refs(file = "sample_size_justification.bib")
```
